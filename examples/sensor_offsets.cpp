...
int main()
{
    ...
    Position p_camera = {0.5, 0.0, 1.2}; // in front of the camera
    Position p_lidar  = {1.0, -0.2, 0.3};
    Position p_radar  = {2.5, 0.1, 0.2};
    ...
    Position cam_global = localToGlobal(p_camera, cameraFrame);
    Position cam_in_lidar = globalToLocal(cam_global, lidarFrame);
    ...
    Position radar_rot = rotateByQuaternion(qrad, p_radar);
    Position radar_global;
